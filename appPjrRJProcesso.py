...
class Aplicativo(tk.Tk):
    ...
    def iniciar_download(self):
        ...
        if not usuario or not senha:
            ...
            if self.arquivo_excel:
                ...
                self.download_files(usuario, senha, arquivo_excel=None)
            else:
    ...
    #     self.download_files(usuario, senha, numero_processo=None)
  
            
    def download_files(self, usuario, senha, numero_processo=None, arquivo_excel=None):
        ...
        # Se um número de processo foi fornecido, baixe esse processo apenas
        if numero_processo:
            ...
            # Iterar sobre as células da coluna e baixar os processos
            for cell in coluna:
