...
class Aplicativo(tk.Tk):
    ...
    def iniciar_download(self):
        ...
        if not usuario or not senha:
        ...
        elif not self.arquivo_excel or not self.entry_numero_processo.get():
            messagebox.showerror("Erro", "Selecione um arquivo Excel e digite o número do processo.")
        else:
            ...
            while True:
                ...
                success = self.download_files(usuario, senha, numero_processo=numero_processo, row_number=row_number)
    ...
    def download_files(self, usuario, senha, arquivo_excel=None, numero_processo=None, row_number=None):
        try:
            ...
            print(f"Erro ao processar linha {row_number}: {str(e)}")
            return False  # Indica que houve um erro no download
